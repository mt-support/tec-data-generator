...
class CLI {
	 ...
	 * ## EXAMPLES
	 *
	 *     wp rsvp-loadgen add-rsvp 123 --quantity=5
	 *     wp rsvp-loadgen add-rsvp 123 --quantity=5 --capacity=50
	 *     wp rsvp-loadgen add-rsvp 123 --quantity=5 --unlimited-capacity
	 *
	 * @subcommand add-rsvp
	 * @when after_wp_load
	 */
	 ...
	 * ## EXAMPLES
	 *
	 *     wp rsvp-loadgen add-tickets 123 --quantity=5
	 *     wp rsvp-loadgen add-tickets 123 --quantity=5 --capacity=50 --shared-capacity
	 *
	 ...
	 * ## EXAMPLES
	 *
	 *     wp rsvp-loadgen add-attendees 456 --quantity=10
	 *
