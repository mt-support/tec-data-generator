...
Creates event series: groups of related events (with different venues, organizers, details) linked together.
Each event in the series can have tickets and attendees. This is useful for testing series functionality or
creating complex multi-venue event scenarios.
...
# "I need to test event series with multiple venues and organizers."
